...
const Objective = (props: Props) => {
    ...
    <div>
      ...
      <div className="container">
        <div className="sec-title mb-50">
          <h6 className="sub-title wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Obejctive</h6>
          <div className="flex-content">
            <h2 className="title wow splt-txt" data-splitting>
  Strengthen your business <br/> with reliable Dell IT solutions.
</h2>

            <a className="btn-one-rounded wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" href="page-contact.html">Get started <i className="fa-regular fa-angle-right"></i></a>
          </div>
        </div>
  ...
  Your Trusted Dell Partner for IT Solutions and Business Growth
</h4>

              <div className="outer-box">
  <div className="item">
    <div className="icon">
      <img src="./assets/images/icon/objective-icon1.png" alt="Icon"/>
    </div>
    <h5>Corporate IT Solutions</h5>
  </div>
  <div className="item">
    <div className="icon">
      <img src="./assets/images/icon/objective-icon2.png" alt="Icon"/>
    </div>
    <h5>Business IT Support</h5>
  </div>
  <div className="item">
    <div className="icon">
      <img src="./assets/images/icon/objective-icon3.png" alt="Icon"/>
    </div>
    <h5>Dell Server Hosting</h5>
  </div>
</div>
              ...
              <div className="info">
                ...
                <p className="text">Consult With It Advisor? <a href="/contact">Click Now</a></p>
              </div>
              <div className="triangle">
                <img src="./assets/images/shape/objective-triangle.png" alt="Image"/>
              </div>
            </div>
          </div>

          <div className="col-xl-6 content-column wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="inner-column">
              ...
              <div className="tab-content mt-30" id="myTabContent">
                <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  <div className="content">
                    <figure className="image">
                      <img src="./assets/images/about/about-three-image2.jpg" alt="Image"/>
                      <a className="btn-play playbtnanim" href="/"
                  ...
                  <div className="progress mt-30">
                    <div className="progress-single">
                      <h5 className="progress-title">Project Score <span>75%</span></h5>
                      <div className="bar">
                ...
                <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  ...
                  <div className="progress mt-30">
                    <div className="progress-single">
                      <h5 className="progress-title">mission success
                        <span>75%</span>
                      </h5>
                      <div className="bar">
                        <div className="bar-inner count-bar" data-percent="80%"></div>
                ...
                <div className="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  ...
                  <div className="progress mt-30">
                    <div className="progress-single">
                      <h5 className="progress-title">Vision success
                        <span>75%</span>
                      </h5>
                      <div className="bar">
                        <div className="bar-inner count-bar" data-percent="80%"></div>
